...
<?php if(is_front_page() && (floki_get_option( 'hslider' )!="none" && floki_get_option( 'hslider' )!="")) { ?>
       ...
       <!-- <div class="shadow-top"></div>-->
        ...
        <div class="shadow-bottom"></div>
         ...
         <?php if(is_front_page() && (floki_get_option( 'mainimage' )!="" || floki_get_option( 'headertitle' )!="" || floki_get_option( 'headerdescription' )!="")) { ?>
          ...
          <div class="nav2" style="height:100%; overflow:hidden;">
    ...
    <source src="http://douglaswelcome.com/wp-content/uploads/2016/06/road.webm" type="video/webm">
    <source src="http://douglaswelcome.com/wp-content/uploads/2016/06/road.mp4" type="video/mp4">
					</video>
