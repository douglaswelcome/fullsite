...
set_theme_mod("instagram", $instagram);
}
...
<h3><?php _e( 'instagram link', 'floki' ); ?></h3>
<input type="text" name="instagram" id="instagram" value ="<?php echo esc_url(floki_get_option( 'instagram' )); ?>" size="50" /> <br/>
<span><?php _e( 'Write url with http://', 'floki' ); ?></span>
</div>
